...
export class UserChannelsController {
  ...
  @UseGuards(RolesGuard)
  @Get('nick/:nick')
  findChannelByName(@Query('nick') nick: string): Promise<UserChannel>{
  ...
  @UseGuards(RolesGuard)
  @Get('id/:id')
  findChannelByID(@Param('id') id: ObjectId): Promise<UserChannel> {
  ...
  @UseGuards(RolesGuard)
  @Patch(':id')
  update(@Param('id') id: ObjectId, @Body() updateUserChannelDto: UpdateUserChannelDto): Promise<UserChannel> {
